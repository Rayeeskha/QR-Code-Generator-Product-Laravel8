...
<div class="col-xl-12 mx-auto">
	...
	<div class="card-body p-5">
		...
		<div class="card-title d-flex align-items-center">
			...
			<h5 class="mb-0 text-primary">Edit Users</h5>
		</div>
		<hr>
		<form class="row g-3"  action="{{route('user.updateusers')}}" method="post" enctype="multipart/form-data">
			...
			<div class="col-md-6">
				...
				<input type="text" class="form-control" name="lname" value="{{$users[0]->lname}}">
			</div>
			<div class="col-md-6">
			...
			<div class="col-md-6">
				...
				<input type="number" class="form-control" name="mobile" value="{{$users[0]->mobile}}">
			...
			<div class="col-md-6">
				...
				<input type="text" class="form-control" name="totalqrcodes" value="{{$users[0]->total_qr}}">
			...
			<div class="col-md-6">
				...
				<input type="text" class="form-control" name="totalqrhits" value="{{$users[0]->total_hits}}">
			...
			<div class="col-md-6">
				...
				<input type="text" class="form-control" name="password" value="{{$users[0]->dummypass}}">
				@error('password')
                    <span style="color:red;font-weight: 500;font-size: 14px">{{ $message }}</span>
                @enderror
			</div>
			...
			<div class="col-md-4">
				...
				<input type="text" class="form-control" name="State" value="{{$users[0]->State}}">
				@error('State')
                    <span style="color:red;font-weight: 500;font-size: 14px">{{ $message }}</span>
                @enderror
			</div>
			<div class="col-md-4">
				...
				<input type="text" class="form-control" name="city" value="{{$users[0]->city}}">
			...
			<div class="col-md-4">
				...
				<input type="text" class="form-control" name="pinocde" value="{{$users[0]->pinocde}}">
			</div>
			
			<div class="col-12">
				<label for="inputAddress" class="form-label">Address <span style="color: red">*</span></label>
				<textarea class="form-control" name="address" placeholder="Address..." rows="3">{{$users[0]->address}}</textarea>
